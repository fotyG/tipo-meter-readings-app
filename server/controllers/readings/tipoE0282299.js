...
const editTipoE0282299 = async (req, res) => {
  try {
    const editedItem = await TipoE0282299.findByIdAndUpdate(
      req.params.id,
      req.body
    )
...
const getOneTipoE0282299 = async (req, res) => {
  try {
    const oneReading = await TipoE0282299.findById(req.params.id)
